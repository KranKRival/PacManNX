...
void Sounds::initialize() {
	...
	if (audioAvailable) {
		chunk_munch_a = loadWaveSound("assets/sounds/munch_a.wav");
		chunk_munch_b = loadWaveSound("assets/sounds/munch_b.wav");
		chunk_dying = loadWaveSound("assets/sounds/death_1.wav");
		chunk_extra_man = loadWaveSound("assets/sounds/extra_man.wav");
		chunk_fruit = loadWaveSound("assets/sounds/fruit.wav");
		chunk_eat_ghost = loadWaveSound("assets/sounds/ghost_eat_3.wav");
		music_intro = loadWaveMusic("assets/sounds/intro.wav");
		music_siren_slow = loadWaveMusic("assets/sounds/siren_slow.wav");
		music_siren_medium = loadWaveMusic("assets/sounds/siren_medium.wav");
		music_siren_fast = loadWaveMusic("assets/sounds/siren_fast.wav");
		music_superpill_loop = loadWaveMusic("assets/sounds/large_pellet_loop.wav");
		music_eat_ghost = loadWaveMusic("assets/sounds/ghost_eat_1.wav");
		initialized = true;
	} else {
		enabled      = false;
		musicEnabled = false;
