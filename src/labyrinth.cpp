...
Labyrinth::Labyrinth():
	...
	pille            = Screen::loadImage("assets/gfx/pille.png", 0);
	ar_superpille[0] = Screen::loadImage("assets/gfx/superpille_1.png", 0);
	ar_superpille[1] = Screen::loadImage("assets/gfx/superpille_2.png", 0);
	ar_superpille[2] = Screen::loadImage("assets/gfx/superpille_3.png", 0);
	ar_superpille[3] = Screen::loadImage("assets/gfx/superpille_3.png", 0);
	ar_superpille[4] = Screen::loadImage("assets/gfx/superpille_2.png", 0);
...
void Labyrinth::loadLevelFruit() {
	...
	switch(level->getLevelNumber()) {
		case 1:
			setFruitBonus(100);
			infoFruit = Screen::loadImage("assets/gfx/cherry.png", 255);
			break;
		case 2:
			setFruitBonus(300);
			infoFruit = Screen::loadImage("assets/gfx/strawberry.png", 255);
			break;
		case 3:
		case 4:
			setFruitBonus(500);
			infoFruit = Screen::loadImage("assets/gfx/orange.png", 255);
			break;
		case 5:
		case 6:
			setFruitBonus(700);
			infoFruit = Screen::loadImage("assets/gfx/apple.png", 255);
			break;
		case 7:
		case 8:
			setFruitBonus(1000);
			infoFruit = Screen::loadImage("assets/gfx/grapes.png", 255);
			break;
		case 9:
		case 10:
			setFruitBonus(2000);
			infoFruit = Screen::loadImage("assets/gfx/banana.png", 255);
			break;
		case 11:
		case 12:
			setFruitBonus(3000);
			infoFruit = Screen::loadImage("assets/gfx/pear.png", 255);
			break;
		default:
			setFruitBonus(5000);
			infoFruit = Screen::loadImage("assets/gfx/key.png", 255);
	};
...
SDL_Surface *Labyrinth::getBackground() {
	if (!bgSurface) {
		bgSurface = Screen::loadImage("assets/gfx/hintergrund2.png");
	}
	return bgSurface;
}
