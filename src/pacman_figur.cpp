	...
	idxCurrentRail(33)
{
	...
	direction = LEFT;
	direction_pre = LEFT;
	pacman_normal   = Screen::loadImage("assets/gfx/pacman.png", 255);
	pacman_links_1  = Screen::loadImage("assets/gfx/pacman_links_1.png", 255);
    pacman_links_2  = Screen::loadImage("assets/gfx/pacman_links_2.png", 255);
    pacman_oben_1   = Screen::loadImage("assets/gfx/pacman_oben_1.png", 255);
    pacman_oben_2   = Screen::loadImage("assets/gfx/pacman_oben_2.png", 255);
    pacman_rechts_1 = Screen::loadImage("assets/gfx/pacman_rechts_1.png", 255);
    pacman_rechts_2 = Screen::loadImage("assets/gfx/pacman_rechts_2.png", 255);
    pacman_unten_1  = Screen::loadImage("assets/gfx/pacman_unten_1.png", 255);
    pacman_unten_2  = Screen::loadImage("assets/gfx/pacman_unten_2.png", 255);
    ...
    ar_pacman_die[0]  = Screen::loadImage("assets/gfx/pacman_die_1.png",  255);
    ar_pacman_die[1]  = Screen::loadImage("assets/gfx/pacman_die_2.png",  255);
    ar_pacman_die[2]  = Screen::loadImage("assets/gfx/pacman_die_3.png",  255);
    ar_pacman_die[3]  = Screen::loadImage("assets/gfx/pacman_die_4.png",  255);
    ar_pacman_die[4]  = Screen::loadImage("assets/gfx/pacman_die_5.png",  255);
    ar_pacman_die[5]  = Screen::loadImage("assets/gfx/pacman_die_6.png",  255);
	ar_pacman_die[6]  = Screen::loadImage("assets/gfx/pacman_die_10.png", 255);
	ar_pacman_die[7]  = Screen::loadImage("assets/gfx/pacman_die_10.png", 255);
	ar_pacman_die[8]  = Screen::loadImage("assets/gfx/pacman_die_10.png", 255);
	ar_pacman_die[9]  = Screen::loadImage("assets/gfx/pacman_die_7.png",  255);
    ar_pacman_die[10] = Screen::loadImage("assets/gfx/pacman_die_8.png",  255);
    ar_pacman_die[11] = Screen::loadImage("assets/gfx/pacman_die_9.png",  255);
    ar_pacman_die[12] = Screen::loadImage("assets/gfx/pacman_die_7.png",  255);
    ar_pacman_die[13] = Screen::loadImage("assets/gfx/pacman_die_8.png",  255);
    ar_pacman_die[14] = Screen::loadImage("assets/gfx/pacman_die_9.png",  255);
    ar_pacman_die[15] = Screen::loadImage("assets/gfx/pacman_die_9.png",  255);
