	...
	panicMode(0)
{
	...
	if(ghost_ident == BLINKY) {
		ghost_1 = Screen::loadImage("assets/gfx/blinky_1.png", 255);
		ghost_2 = Screen::loadImage("assets/gfx/blinky_2.png", 255);
		idxCurrentRail = 16;
	}
	else if(ghost_ident == PINKY) {
		ghost_1 = Screen::loadImage("assets/gfx/pinky_1.png", 255);
		ghost_2 = Screen::loadImage("assets/gfx/pinky_2.png", 255);
		idxCurrentRail = 89;
	}
	else if(ghost_ident == INKY) {
		ghost_1 = Screen::loadImage("assets/gfx/inky_1.png", 255);
		ghost_2 = Screen::loadImage("assets/gfx/inky_2.png", 255);
		idxCurrentRail = 88;
	}
	else if(ghost_ident == CLYDE) {
		ghost_1 = Screen::loadImage("assets/gfx/clyde_1.png", 255);
		ghost_2 = Screen::loadImage("assets/gfx/clyde_2.png", 255);
		idxCurrentRail = 90;
	}
	augen_0        = Screen::loadImage("assets/gfx/augen_0.png", 0);
	augen_1        = Screen::loadImage("assets/gfx/augen_1.png", 0);
	augen_2        = Screen::loadImage("assets/gfx/augen_2.png", 0);
	augen_3        = Screen::loadImage("assets/gfx/augen_3.png", 0);
	escape_1       = Screen::loadImage("assets/gfx/escaping_ghost_1.png", 255);
	escape_2       = Screen::loadImage("assets/gfx/escaping_ghost_2.png", 255);
	escape_white_1 = Screen::loadImage("assets/gfx/escaping_ghost_white_1.png", 0);
	escape_white_2 = Screen::loadImage("assets/gfx/escaping_ghost_white_2.png", 0);
	ar_ghost[0] = ghost_1;
	ar_ghost[1] = ghost_2;
