...
FunnyAnimation::FunnyAnimation():
	...
	labyrinth(Labyrinth::getInstance()){
		...
		const char* fruits[NUM_FRUITS][2] = {{"assets/gfx/cherry.png",     "100"},
											 {"assets/gfx/strawberry.png", "300"},
											 {"assets/gfx/orange.png",     "500"},
											 {"assets/gfx/apple.png",      "700"},
											 {"assets/gfx/grapes.png",    "1000"},
											 {"assets/gfx/banana.png",    "2000"},
											 {"assets/gfx/pear.png",      "3000"},
											 {"assets/gfx/key.png",       "5000"}};
